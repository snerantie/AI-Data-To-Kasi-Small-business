...
export const t = {
  ...
  // Borrower identity — the borrower confirms their own SA ID + agrees,
  // binding the loan to a real person (first-pass Tshivenḓa).
  mashonisaConfirmTitle: {
    en: "Confirm the borrower",
    zu: "Qinisekisa umboleki",
    st: "Netefatsa moadimi",
    af: "Bevestig die lener",
    ve: "Khwaṱhisedzani muadzimi",
  },
  mashonisaBorrowerHere: {
    en: "Borrower is here",
    zu: "Umboleki ukhona",
    st: "Moadimi o teng",
    af: "Lener is hier",
  ...
  mashonisaCashOnly: {
    en: "Cash only (no ID)",
    zu: "Imali kuphela (ayikho i-ID)",
    st: "Chelete feela (ha ho ID)",
    af: "Net kontant (geen ID)",
    ve: "Tshelede fhedzi (a hu na ID)",
  },
  mashonisaSendLink: {
    en: "Send a link",
    ...
    st: "Romela sehokelo",
    af: "Stuur 'n skakel",
    ve: "Rumelani vhukwamani",
  },
  mashonisaIdLabel: {
    en: "Borrower's ID number",
    zu: "Inombolo ye-ID yomboleki",
    st: "Nomoro ea ID ea moadimi",
    af: "Lener se ID-nommer",
    ve: "Nomboro ya ID ya muadzimi",
  },
  mashonisaIdPlaceholder: {
    en: "13-digit SA ID",
    zu: "I-ID yaseSA yezinombolo eziyi-13",
    st: "ID ea SA ea dinomoro tse 13",
    af: "13-syfer SA ID",
    ve: "ID ya SA ya dzinomboro dza 13",
  },
  mashonisaIdInvalid: {
    en: "Enter a valid 13-digit SA ID",
    zu: "Faka i-ID yaseSA evumelekile enezinombolo eziyi-13",
    st: "Kenya ID ea SA e nepahetseng ea dinomoro tse 13",
    af: "Voer 'n geldige 13-syfer SA ID in",
    ve: "Dzhenisani ID ya SA yo teaho ya dzinomboro dza 13",
  },
  mashonisaIdValid: {
    en: "Valid ID",
    zu: "I-ID evumelekile",
  ...
  mashonisaAgreeText: {
    en: "The borrower agrees: this loan is linked to my ID and my repayment record. Paying on time builds my credit — not paying reflects on me.",
    zu: "Umboleki uyavuma: lesi sikweletu sixhunywe ne-ID yami nerekhodi lami lokukhokha. Ukukhokha ngesikhathi kwakha isikweletu sami — ukungakhokhi kubonakala kimi.",
    st: "Moadimi oa lumela: mokitlane ona o hokahane le ID ea ka le rekoto ea ka ea ho lefa. Ho lefa ka nako ho aha mokitlane oa ka — ho se lefe ho bonahala ho 'na.",
    af: "Die lener stem in: hierdie lening is aan my ID en my terugbetalingsrekord gekoppel. Betyds betaal bou my krediet — nie betaal weerspieël op my.",
    ve: "Muadzimi u a tenda: mukolodo uyu wo vhofhekanywa na ID yanga na rekhodo yanga ya u badela. U badela nga tshifhinga zwi fhaṱa mukolodo wanga — u sa badeli zwi sumbedza kha nṋe.",
  },
  mashonisaAgreeConfirm: {
    en: "I agree",
    zu: "Ngiyavuma",
    st: "Kea lumela",
    af: "Ek stem in",
  ...
  mashonisaIdConfirmedBadge: {
    en: "ID confirmed",
    zu: "I-ID iqinisekisiwe",
    st: "ID e netefalitsoe",
    af: "ID bevestig",
    ve: "ID yo khwaṱhisedzwa",
  },
  mashonisaUnverifiedBadge: {
    en: "Unverified",
    zu: "Akuqinisekisiwe",
    st: "Ha ea netefatsoa",
    af: "Ongeverifieer",
    ve: "A yo ngo khwaṱhisedzwa",
  },
  // Phase 2 — remote confirmation ("send a link").
  mashonisaAwaitingBadge: {
    en: "Awaiting borrower",
    zu: "Kulindwe umboleki",
    st: "Ho emetsoe moadimi",
    af: "Wag vir lener",
    ve: "Hu lindelwa muadzimi",
  },
  mashonisaShareLink: {
    en: "Send WhatsApp link",
    zu: "Thumela isixhumanisi se-WhatsApp",
    st: "Romela sehokelo sa WhatsApp",
    af: "Stuur WhatsApp-skakel",
    ve: "Rumelani vhukwamani ha WhatsApp",
  },
  mashonisaAwaitingHint: {
    en: "Create the loan, then share the WhatsApp link so the borrower confirms their ID on their own phone.",
    zu: "Yakha isikweletu, bese wabelana ngesixhumanisi se-WhatsApp ukuze umboleki aqinisekise i-ID yakhe efonini yakhe.",
    st: "Theha mokitlane, ebe u arolelana sehokelo sa WhatsApp hore moadimi a netefatse ID ea hae fonong ea hae.",
    af: "Skep die lening, deel dan die WhatsApp-skakel sodat die lener sy ID op sy eie foon bevestig.",
    ve: "Sikani mukolodo, nga murahu ni goavhelane vhukwamani ha WhatsApp uri muadzimi a khwaṱhisedze ID yawe kha luṱingo lwawe.",
  },
  mashonisaConfirmWhatsAppMessage: {
    en: "Please confirm your R{amount} loan on KasiKash — enter your ID to agree: {url}",
    zu: "Sicela uqinisekise isikweletu sakho sika-R{amount} ku-KasiKash — faka i-ID yakho ukuze uvume: {url}",
    st: "Ka kopo netefatsa mokitlane oa hao oa R{amount} ho KasiKash — kenya ID ea hao ho lumela: {url}",
    af: "Bevestig asseblief jou R{amount} lening op KasiKash — voer jou ID in om in te stem: {url}",
    ve: "Ni khou humbelwa u khwaṱhisedza mukolodo waṋu wa R{amount} kha KasiKash — dzhenisani ID yaṋu u tenda: {url}",
  },
  // Borrower-facing confirmation screen (public, no login).
  bcTitle: {
    en: "Confirm your loan",
    zu: "Qinisekisa isikweletu sakho",
    st: "Netefatsa mokitlane oa hao",
    af: "Bevestig jou lening",
    ve: "Khwaṱhisedzani mukolodo waṋu",
  },
  bcSubtitle: {
    en: "A lender has recorded a loan for you. Confirm your details to agree — it links this loan to your ID and builds your credit record.",
    zu: "Umbolekisi ubhalise isikweletu ngawe. Qinisekisa imininingwane yakho ukuze uvume — kuxhumanisa lesi sikweletu ne-ID yakho futhi kwakhe irekhodi lakho lesikweletu.",
    st: "Moadimisi o ngotse mokitlane bakeng sa hao. Netefatsa lintlha tsa hao ho lumela — ho hokahanya mokitlane ona le ID ea hao 'me ho aha rekoto ea hao ea mokitlane.",
    af: "'n Uitlener het 'n lening vir jou aangeteken. Bevestig jou besonderhede om in te stem — dit koppel hierdie lening aan jou ID en bou jou kredietrekord.",
    ve: "Muadzimisi o rekhoda mukolodo wo itelwa inwi. Khwaṱhisedzani zwidodombedzwa zwaṋu u tenda — zwi vhofhekanya mukolodo uyu na ID yaṋu nahone zwi fhaṱa rekhodo yaṋu ya mukolodo.",
  },
  bcNameLabel: {
    en: "Your full name",
    zu: "Igama lakho eliphelele",
    st: "Lebitso la hao le felletseng",
    af: "Jou volle naam",
    ve: "Dzina ḽaṋu ḽoṱhe",
  },
  bcSubmit: {
    en: "Confirm & agree",
    zu: "Qinisekisa uvume",
    st: "Netefatsa 'me u lumele",
    af: "Bevestig en stem in",
    ve: "Khwaṱhisedzani ni tende",
  },
  bcSuccessTitle: {
    en: "Confirmed — thank you",
    zu: "Kuqinisekisiwe — siyabonga",
    st: "Ho netefalitsoe — kea leboha",
    af: "Bevestig — dankie",
    ve: "Zwo khwaṱhisedzwa — ndi a livhuwa",
  },
  bcSuccessBody: {
    en: "This loan is now linked to your ID. Repaying on time builds your credit record on KasiKash.",
    zu: "Lesi sikweletu manje sixhunywe ne-ID yakho. Ukukhokha ngesikhathi kwakha irekhodi lakho lesikweletu ku-KasiKash.",
    st: "Mokitlane ona hona joale o hokahane le ID ea hao. Ho lefa ka nako ho aha rekoto ea hao ea mokitlane ho KasiKash.",
    af: "Hierdie lening is nou aan jou ID gekoppel. Betyds betaal bou jou kredietrekord op KasiKash.",
    ve: "Mukolodo uyu zwino wo vhofhekanywa na ID yaṋu. U badela nga tshifhinga zwi fhaṱa rekhodo yaṋu ya mukolodo kha KasiKash.",
  },
  bcNotFoundTitle: {
    en: "This link isn't valid",
    zu: "Lesi sixhumanisi asisebenzi",
    st: "Sehokelo sena ha se sebetse",
    af: "Hierdie skakel is nie geldig nie",
    ve: "Vhukwamani honovhu a vhu shumi",
  },
  bcNotFoundBody: {
    en: "It may have expired or already been used. Ask the lender to send a new one.",
    zu: "Kungenzeka liphelelwe yisikhathi noma selissetshenzisiwe. Cela umbolekisi akuthumelele elisha.",
    st: "E ka 'na ea felloa ke nako kapa e se e sebelisitsoe. Kōpa moadimisi ho romela e ncha.",
    af: "Dit het dalk verval of is reeds gebruik. Vra die uitlener om 'n nuwe een te stuur.",
    ve: "Vhu nga vha vho fhelelwa nga tshifhinga kana ho no shumiswa. Humbelani muadzimisi u rumela huswa.",
  },
  bcLoading: {
    en: "Loading…",
    zu: "Iyalayisha…",
  ...
  bcError: {
    en: "Couldn't confirm just now. Please try again.",
    zu: "Ayikwazanga ukuqinisekisa manje. Sicela uzame futhi.",
    st: "Ha ea khona ho netefatsa hona joale. Ka kopo leka hape.",
    af: "Kon nie nou bevestig nie. Probeer asseblief weer.",
    ve: "A zwo ngo kona u khwaṱhisedza zwino. Ni humbelwa u lingedza hafhu.",
  },
  ...
  // ---------------------------------------------------------------------
  // PR #51 — Stokvel dashboard, contribution schedule, group health,
  // payouts, contribution history, and automatic reminders.
  // ---------------------------------------------------------------------
  dashboardTitle: {
    en: "Dashboard",
    zu: "Ideshbhodi",
  ...
  dashBalance: {
    en: "Group balance",
    zu: "Ibhalansi yeqembu",
    st: "Tekanyo ea sehlopha",
    af: "Groepsaldo",
    ve: "Tshelede ya tshigwada",
  },
  dashPaidOut: {
    en: "{amount} paid out",
    zu: "{amount} okukhishiwe",
    st: "{amount} e lefiloeng",
    af: "{amount} uitbetaal",
    ve: "{amount} yo badelwaho",
  },
  dashMembers: {
    en: "Members",
    zu: "Amalungu",
  ...
  dashMembersSub: {
    ...
    st: "sehlopheng sena",
    af: "in hierdie groep",
    ve: "kha tshigwada tshenetshi",
  },
  dashPaidThisMonth: {
    en: "Paid this month",
    zu: "Kukhokhelwe kule nyanga",
    st: "Ho lefiloe khoeling ena",
    af: "Betaal hierdie maand",
    ve: "Zwo badelwa nwedzi uno",
  },
  dashMembersPaid: {
    en: "{paid}/{total} members paid",
    zu: "Amalungu angu-{paid}/{total} akhokhile",
    st: "Litho tse {paid}/{total} li lefile",
    af: "{paid}/{total} lede het betaal",
    ve: "Miraḓo {paid}/{total} yo badela",
  },
  dashThisMonth: {
    en: "this month",
    zu: "kule nyanga",
  ...
  dashMembersOwe: {
    en: "{count} still to pay",
    zu: "Angu-{count} asasekhokhela",
    st: "Tse {count} li ntse li lokela ho lefa",
    af: "{count} moet nog betaal",
    ve: "{count} vha kha ḓi badela",
  },
  dashNoSchedule: {
    en: "Set a schedule",
    zu: "Setha ishejuli",
  ...
  dashNextPayday: {
    en: "Next payday",
    zu: "Usuku lokukhokha olulandelayo",
    st: "Letsatsi le latelang la tefo",
    af: "Volgende uitbetaaldag",
    ve: "Ḓuvha ḽi tevhelaho ḽa mbadelo",
  },
  ...
  scheduleEmptyTitle: {
    en: "Set a contribution schedule",
    zu: "Setha ishejuli yeminikelo",
    st: "Beha kemiso ea menehelo",
    af: "Stel 'n bydrae-skedule",
    ve: "Vhea mutevhe wa mineelo",
  },
  scheduleEmptyBody: {
    en: "Add the monthly amount, the day it's due and the payout day so everyone knows what to pay and when.",
    zu: "Engeza inani lenyanga, usuku okumele kukhokhwe ngalo nosuku lokukhokha ukuze wonke umuntu azi ukuthi akhokhe malini nanini.",
    st: "Kenya chelete ea khoeli, letsatsi leo e lokelang ho lefuoa ka lona le letsatsi la tefo e le hore e mong le e mong a tsebe hore na a lefe bokae le neng.",
    af: "Voeg die maandelikse bedrag, die dag wanneer dit betaalbaar is en die uitbetaaldag by sodat almal weet wat om te betaal en wanneer.",
    ve: "Engedzani tshelede ya nwedzi, ḓuvha ḽine ya tea u badelwa na ḓuvha ḽa mbadelo uri munwe na munwe a ḓivhe zwine a tea u badela na musi.",
  },
  scheduleSheetTitle: {
    en: "Contribution schedule",
    zu: "Ishejuli yeminikelo",
    st: "Kemiso ea menehelo",
    af: "Bydrae-skedule",
    ve: "Mutevhe wa mineelo",
  },
  scheduleSheetIntro: {
    en: "Members will see the amount and dates, and get a reminder near the due day.",
    zu: "Amalungu azobona inani nezinsuku, futhi athole isikhumbuzo eduze kosuku lokukhokha.",
    st: "Litho li tla bona chelete le matsatsi, 'me li fumane khopotso haufi le letsatsi la tefo.",
    af: "Lede sal die bedrag en datums sien, en 'n herinnering naby die betaaldag kry.",
    ve: "Miraḓo i ḓo vhona tshelede na maḓuvha, na u wana khumbudzo tsini na ḓuvha ḽa mbadelo.",
  },
  scheduleAmountLabel: {
    en: "Monthly contribution (per member)",
    zu: "Umnikelo wenyanga (ilungu ngalinye)",
    st: "Monehelo oa khoeli (setho ka seng)",
    af: "Maandelikse bydrae (per lid)",
    ve: "Mineelo ya nwedzi (muraḓo muṅwe na muṅwe)",
  },
  ...
  scheduleWeekly: {
    ...
    st: "Beke le beke",
    af: "Weekliks",
    ve: "Vhege iṅwe na iṅwe",
  },
  scheduleContribDayLabel: {
    en: "Contribution day",
    zu: "Usuku lomnikelo",
    st: "Letsatsi la monehelo",
    af: "Bydraedag",
    ve: "Ḓuvha ḽa mineelo",
  },
  schedulePayoutDayLabel: {
    en: "Payout day",
    zu: "Usuku lokukhokha",
    st: "Letsatsi la tefo",
    af: "Uitbetaaldag",
  ...
  scheduleDayHint: {
    en: "Day of the month (1–31). We'll clamp it to the last day for shorter months.",
    zu: "Usuku lwenyanga (1–31). Sizolubeka osukwini lokugcina ezinyangeni ezimfushane.",
    st: "Letsatsi la khoeli (1–31). Re tla le fetola ho letsatsi la ho qetela likhoeling tse khutšoanyane.",
    af: "Dag van die maand (1–31). Ons pas dit aan na die laaste dag vir korter maande.",
    ve: "Ḓuvha ḽa nwedzi (1–31). Ri ḓo ḽi vhea kha ḓuvha ḽa u fhedza kha minwedzi mipfufhi.",
  },
  scheduleSaveBtn: {
    en: "Save schedule",
    zu: "Londoloza ishejuli",
    st: "Boloka kemiso",
    af: "Stoor skedule",
    ve: "Vhulunga mutevhe",
  },
  scheduleSaveError: {
    en: "Couldn't save the schedule. Only an admin can change it — please try again.",
    zu: "Ayikwazanga ukulondoloza ishejuli. Umphathi kuphela ongayishintsha — sicela uzame futhi.",
    st: "Ha ea khona ho boloka kemiso. Ke molaodi feela ea ka e fetolang — ka kopo leka hape.",
    af: "Kon nie die skedule stoor nie. Net 'n admin kan dit verander — probeer weer.",
    ve: "A zwo konadzea u vhulunga mutevhe. Ndi mulanguli fhedzi ane a nga u shandula — lingedzani hafhu.",
  },
  ...
  healthTitle: {
    en: "Group health",
    zu: "Impilo yeqembu",
    st: "Bophelo ba sehlopha",
    af: "Groepgesondheid",
    ve: "Mutakalo wa tshigwada",
  },
  healthOnTimePct: {
    en: "{pct}% paid on time",
    zu: "{pct}% kukhokhwe ngesikhathi",
    st: "{pct}% e lefiloe ka nako",
    af: "{pct}% betyds betaal",
    ve: "{pct}% zwo badelwa nga tshifhinga",
  },
  healthOnTimeSub: {
    en: "{onTime} of {total} contributions on time",
    zu: "{onTime} kwabangu-{total} beminikelo ngesikhathi",
    st: "{onTime} ho tse {total} tsa menehelo ka nako",
    af: "{onTime} van {total} bydraes betyds",
    ve: "{onTime} kha {total} ya mineelo nga tshifhinga",
  },
  healthHealthy: {
    en: "Healthy",
    zu: "Kuhle",
  ...
  payoutRecordBtn: {
    ...
    zu: "Bhala inkokhelo",
    st: "Ngola tefo",
    af: "Teken 'n uitbetaling aan",
    ve: "Ṅwalani mbadelo",
  },
  payoutsEmpty: {
    en: "No payouts yet. When the group pays money out of the fund, it'll show here.",
    zu: "Azikho izinkokhelo okwamanje. Lapho iqembu likhipha imali esikhwameni, izovela lapha.",
    st: "Ha ho na litefo hajoale. Ha sehlopha se ntša chelete letloleng, e tla bonahala mona.",
    af: "Nog geen uitbetalings nie. Wanneer die groep geld uit die fonds betaal, sal dit hier wys.",
    ve: "A hu athu vha na mbadelo. Musi tshigwada tshi tshi bvisa tshelede kha tshikwama, zwi ḓo bonala hafha.",
  },
  payoutToFund: {
    en: "Payout",
    zu: "Inkokhelo",
  ...
  payoutSheetTitle: {
    ...
    zu: "Bhala inkokhelo",
    st: "Ngola tefo",
    af: "Teken uitbetaling aan",
    ve: "Ṅwalani mbadelo",
  },
  payoutAvailable: {
    en: "Available in fund",
    zu: "Okutholakalayo esikhwameni",
    st: "E fumanehang letloleng",
    af: "Beskikbaar in fonds",
    ve: "Zwi wanalaho kha tshikwama",
  },
  payoutAmountLabel: {
    en: "Payout amount",
    zu: "Inani lenkokhelo",
    st: "Chelete ea tefo",
    af: "Uitbetaalbedrag",
    ve: "Tshelede ya mbadelo",
  },
  payoutOverAvailable: {
    en: "That's more than the fund balance.",
    zu: "Lokho kungaphezu kwebhalansi yesikhwama.",
    st: "Seo se feta chelete e letloleng.",
    af: "Dis meer as die fondssaldo.",
    ve: "Zwenezwo zwi fhira tshelede i re tshikwamani.",
  },
  ...
  payoutRecipientNamePlaceholder: {
    en: "Recipient name",
    zu: "Igama lomamukeli",
    st: "Lebitso la moamoheli",
    af: "Ontvanger se naam",
    ve: "Dzina ḽa muṱanganedzi",
  },
  payoutNoteLabel: {
    en: "Note (optional)",
    zu: "Inothi (okukhethwa)",
    st: "Tlhaloso (boikhethelo)",
    af: "Nota (opsioneel)",
    ve: "Ṅwaledzi (a si mbofho)",
  },
  payoutNotePlaceholder: {
    en: "e.g. November payout",
    zu: "isb. inkokhelo kaNovemba",
    st: "mohl. tefo ea Pulungoana",
    af: "bv. November-uitbetaling",
    ve: "sa tsumbo, mbadelo ya Ḽara",
  },
  payoutErrorGeneric: {
    en: "Couldn't record the payout. Please try again.",
    zu: "Ayikwazanga ukubhala inkokhelo. Sicela uzame futhi.",
    st: "Ha ea khona ho ngola tefo. Ka kopo leka hape.",
    af: "Kon nie die uitbetaling aanteken nie. Probeer weer.",
    ve: "A zwo konadzea u ṅwala mbadelo. Lingedzani hafhu.",
  },
  payoutSavingProgress: {
    en: "Recording…",
    zu: "Iyabhala…",
    st: "Ea ngola…",
    af: "Teken aan…",
  ...
  historySheetTitle: {
    ...
    zu: "Umlando weminikelo",
    st: "Histori ea menehelo",
    af: "Bydrae-geskiedenis",
    ve: "Ḓivhazwakale ya mineelo",
  },
  historyEmpty: {
    en: "No contributions yet.",
    zu: "Ayikho iminikelo okwamanje.",
    st: "Ha ho na menehelo hajoale.",
    af: "Nog geen bydraes nie.",
    ve: "A hu athu vha na mineelo.",
  },
  confirmedBadge: {
    en: "Confirmed",
    zu: "Kuqinisekisiwe",
  ...
  // Automatic reminders
  remindTitle: {
    en: "Contribution reminder",
    zu: "Isikhumbuzo somnikelo",
    st: "Khopotso ea monehelo",
    af: "Bydrae-herinnering",
    ve: "Khumbudzo ya mineelo",
  },
  remindUpcomingBody: {
    en: "Your {amount} contribution is due in {days} day(s). Pay it in the stokvel screen.",
    zu: "Umnikelo wakho we-{amount} umele ukhokhwe ezinsukwini ezingu-{days}. Ukhokhe esikrinini sestokvel.",
    st: "Monehelo oa hao oa {amount} o lokela ho lefuoa ka matsatsi a {days}. O lefe skrineng sa stokvel.",
    af: "Jou bydrae van {amount} is oor {days} dag(e) betaalbaar. Betaal dit op die stokvel-skerm.",
    ve: "Mineelo yaṋu ya {amount} i tea u badelwa nga maḓuvha a {days}. I badeleni kha tshiga tsha stokvel.",
  },
  remindDueBody: {
    en: "Your {amount} contribution is due today. Pay it in the stokvel screen.",
    zu: "Umnikelo wakho we-{amount} umele ukhokhwe namuhla. Ukhokhe esikrinini sestokvel.",
    st: "Monehelo oa hao oa {amount} o lokela ho lefuoa kajeno. O lefe skrineng sa stokvel.",
    af: "Jou bydrae van {amount} is vandag betaalbaar. Betaal dit op die stokvel-skerm.",
    ve: "Mineelo yaṋu ya {amount} i tea u badelwa ṋamusi. I badeleni kha tshiga tsha stokvel.",
  },
  remindOverdueBody: {
    en: "Your {amount} contribution is overdue. Pay it in the stokvel screen to stay on track.",
    zu: "Umnikelo wakho we-{amount} usudlulelwe yisikhathi. Ukhokhe esikrinini sestokvel ukuze uhlale usemgudwini.",
    st: "Monehelo oa hao oa {amount} o fetile nako. O lefe skrineng sa stokvel ho lula tseleng.",
    af: "Jou bydrae van {amount} is agterstallig. Betaal dit op die stokvel-skerm om op koers te bly.",
    ve: "Mineelo yaṋu ya {amount} yo fhira tshifhinga. I badeleni kha tshiga tsha stokvel uri ni dzule ni kha buḓo.",
  },
} as const;
